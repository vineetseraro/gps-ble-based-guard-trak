...
exports.routeReports = function(event, context, callback) {
  switch ((event.pathParameters || {}).path) {
    ...
    case 'login-history':
      ...
      break;
    case 'tours':
      reportHandler.getTours(event, context, callback);
      break;
    case 'device-tour-stats':
      reportHandler.getDeviceTourStats(event, context, callback);
      break;
    case 'guard-tour-stats':
      reportHandler.getGuardTourStats(event, context, callback);
      break;
    default:
  }
};
