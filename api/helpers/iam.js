...
iamHelper.prototype.saveGroupPolicy = function saveGroupPolicy(modules, roleName, userPoolId) {
  ...
  if (modules.userpool) {
    Object.getOwnPropertyNames(modules.userpool['User - Admin']).forEach(component => {
      if (component !== 'OPTIONS') {
        allowUserpool = modules.userpool['User - Admin'][component] || allowUserpool;
      }
    });
  }
