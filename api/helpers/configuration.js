...
configurationService.prototype.formatResponse = function(data) {
  ...
  if (!new Set([true, false]).has(data.isMultiDeviceLoginDisabled)) {
    data.isMultiDeviceLoginDisabled = false;
  }
  formattedResponse.isMultiDeviceLoginDisabled = data.isMultiDeviceLoginDisabled;
...
configurationService.prototype.update = function(event) {
  ...
  if (!new Set([true, false]).has(event.body.isMultiDeviceLoginDisabled)) {
    event.body.isMultiDeviceLoginDisabled = false;
  }
  configurationUpdateObj.isMultiDeviceLoginDisabled = event.body.isMultiDeviceLoginDisabled;
