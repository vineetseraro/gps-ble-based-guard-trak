...
/*
     ...
     Logout
 */
    var tableData: [String] = [RearSlider.Dashboard.rawValue,RearSlider.notification.rawValue,RearSlider.history.rawValue, RearSlider.help.rawValue,RearSlider.about.rawValue,RearSlider.logout.rawValue]
...
//            self.revealViewController().setFront(navController, animated: true)
        ...
        case RearSlider.RegionInfo.rawValue:
            ...
            self.revealViewController().revealToggle(animated: true)
            break
        case RearSlider.Dashboard.rawValue:
            let appDelegate = UIApplication.shared.delegate as! AppDelegate
            appDelegate.initSideBarMenu()
            break
        case RearSlider.ScanView.rawValue:
            let scanViewController = EMPScanViewController.init(nibName: "EMPScanViewController", bundle: nil)
            let leftSideNav = UINavigationController(rootViewController: scanViewController)
            self.revealViewController().setFront(leftSideNav, animated: true)
            self.revealViewController().revealToggle(animated: true)
            break
    ...
    func uploadToAWS(){
        ...
        for file in dict!{
            if(file.contains(".csv"))
            {
                ...
                uploadRequest?.bucket = s3bucketId
