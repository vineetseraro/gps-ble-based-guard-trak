...
@Component({
  selector: 'app-search-tourevents',
  templateUrl: './tourevents.component.html',
...
export class ToureventsComponent implements OnInit {
  ...
  searchRecord(searchValue:any) {
    ...
    if (searchValue.actionType !== null && searchValue.actionType !== '') {
      query += '&actionType=' + searchValue.actionType;
    }
    ...
    this.commonService.notifyOther({ option: 'tourevents_search', value: query });
    this.closeSearchBox('');
  }
